...
int main()
{
    ...
    // -------------------------
    Shader shader("shadow_mapping_vertex.glsl", "shadow_mapping_fragment.glsl");
    Shader simpleDepthShader("shadow_mapping_depth_vertex.glsl", "shadow_mapping_depth_fragment.glsl", "shadow_mapping_depth_geom.glsl");
    Shader lampShader("vertex_lamp.glsl", "fragment_lamp.glsl");
    Shader normalMappingShader("normal_mapping_vertex.glsl", "normal_mapping_fragment.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.99f));
...
void renderScene(const Shader& shader)
{
    ...
    renderCube();
    model = glm::mat4(1.0f);
    model = glm::translate(model, glm::vec3(2.0f, -3.0f, 0.0));
